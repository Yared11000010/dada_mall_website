    ...
    <body>
        {{-- <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <section class="container" style="padding-top: 200px;">
                <div class="row">
                       <div class="col">
                         <h2 class="text-center">All Questions and Answers</h2>
                            <div style="background-color: rgb(17, 75, 141);" class="container mt-5 mb-2">
                                <div class="row">
                                    @foreach ($allanswer as $eset)
                                    <div class="col-md-4 mt-2 mb-2">
                                        <div class="card">
                                            <div class="card-body">
                                                <h5 class="card-title">{{ $eset->questions }}</h5>
                                                <p class="card-text">{{ $eset->answers }}</p>
                                            </div>
                                            <small>Date: &nbsp;{{ $eset->created_at }}</small>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
